...
- For more information about the frontend including references, and client startup, please see our [README](./client/README.md).
- Please contact any of the project member to get the `.env` file for the client.
- AJAX Documentation is found [here](https://github.com/C404TEAMW21/CMPUT404_PROJECT/wiki/AJAX-Documentation).
...
_Frontend related references will be found in the client folder [README](./client/README.md)_
